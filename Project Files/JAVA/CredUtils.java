...
public class CredUtils {
    ...
    public static List<Cred> extractFeatureFromJson(String packetJSON){
        ...
        List<Cred> packets=new ArrayList<>();
        ...
        try {
            ...
            if (resultArray.length()>0){
                ...
                for (int i=0;i<resultArray.length();i++){
                    ...
                    String x=properties.getString("pass");
                    String y=properties.getString("type");

                    Cred packet=new Cred(id,x,y);
    ...
    public static List<Cred> fetchData(String requestUrl){
        ...
        List<Cred> packets = extractFeatureFromJson(jsonResponse);

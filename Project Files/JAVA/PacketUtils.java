...
public class PacketUtils {
    ...
    public static List<Packet> extractFeatureFromJson(String packetJSON){
        ...
        try {
            ...
            if (resultArray.length()>0){
                ...
                for (int i=0;i<resultArray.length();i++){
                    ...
                    String x=properties.getString("name");
                    String y=properties.getString("address");

                    Packet packet=new Packet(id,x,y);
    ...
    public static List<Packet> fetchData(String requestUrl){
        ...
        List<Packet> packets = extractFeatureFromJson(jsonResponse);

...
public class LockUtils {
    ...
    public static List<Lock> extractFeatureFromJson(String packetJSON){
        ...
        List<Lock> packets=new ArrayList<>();
        ...
        try {
            ...
            if (resultArray.length()>0){
                ...
                for (int i=0;i<resultArray.length();i++){
                    ...
                    String id=properties.getString("lock_no");
                    String x=properties.getString("isbn_no");

                    Lock packet=new Lock(id,x);
    ...
    public static List<Lock> fetchData(String requestUrl){
        ...
        List<Lock> packets = extractFeatureFromJson(jsonResponse);

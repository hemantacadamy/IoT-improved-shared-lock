...
public class OtpUtils {
    ...
    public static List<Otpv> extractFeatureFromJson(String packetJSON){
        ...
        List<Otpv> packets=new ArrayList<>();
        ...
        try {
            ...
            if (resultArray.length()>0){
                ...
                for (int i=0;i<resultArray.length();i++){
                    ...
                    String otp=properties.getString("otp");

                    Otpv otpv=new Otpv(otp);
    ...
    public static List<Otpv> fetchData(String requestUrl){
        ...
        List<Otpv> otpvs = extractFeatureFromJson(jsonResponse);
